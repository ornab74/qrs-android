...
# Fixed: Kivy 2.3.1 (includes SDL2 patch for ALooper_pollOnce in sensors, supports NDK r28c)
requirements = python3==3.11.9,kivy==2.3.1,kivymd==1.2.0,numpy,pyjnius,android,psutil,httpx,aiosqlite,cryptography==42.0.8,pennylane==0.36.0,pennylane-lightning==0.36.0,llama-cpp-python==0.2.85
...
android.minapi = 24
android.sdk = 35
android.ndk = 28c  # Kept r28c (no downgrade; 2.3.1 patch handles it)
